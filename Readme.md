...
Versions 0.9.32 and up require Java 21 or better.
...
```
mvn clean package
java -jar target/jklarfreader-0.9.35-SNAPSHOT-jar-with-dependencies.jar /path/to/klarf.klarf (optional: /path/to/klarf.json)
```
...
```
mvn clean package
java -cp target/jklarfreader-0.9.35-SNAPSHOT-jar-with-dependencies.jar com.btrapp.jklarfreader.util.KlarfToImage -klarf /path/to/my/klarf.KLAR -image /path/to/image.png -imgSizePx 224
```
